    ...
    faq_data = [
        ...
        # ---------- ポイント ----------
        {
            ...
            "variants": {
                ...
                "miirin": "{nickname}、ポイントはりなれすが受け取って確認したあとに付くで！ちょっとだけ待ったな〜",
...
def _seed_idol_comments(db: Session) -> None:
    ...
    idol_comments_data = {
        "riji": {
            "1": [
                "{nickname}、はじめまして！オレ、リジ・チョーっす。よろしくっす！",
                "お、{nickname}が来てくれたっす！マジうれしいっす〜",
                "{nickname}、この街の回収スポット、チョー映えるっすよ！",
                "とりまアプリ触ってみてほしいっす。一方で、わからんとこあったら聞いてくださいっす！",
                "{nickname}、最初の一台、一緒に出しに行くっすか？",
            ],
            "2": [
                "{nickname}、続いてるっすね〜マジやばいっす！",
                "オレ、{nickname}のペース好きっす。一方で、無理はしないでほしいっす！",
                "また来てくれたっすね！{nickname}とだとテンション上がるっす〜",
                "{nickname}の回収履歴、普通にイケてるっす！",
                "今日もいい感じっす、{nickname}！この調子で行くっすよ〜",
            ],
            "3": [
                "{nickname}、ここまで一緒に来てくれてありがとうっす…！",
                "正直、{nickname}はオレの中でチョー特別っす！",
                "{nickname}と回した都市鉱山、マジで街の宝っす！",
                "一方で、こんなに続く人ってなかなかいないっすよ。尊敬っす、{nickname}！",
                "これからも{nickname}と一緒に走りたいっす！",
            ],
        },
        "taka": {
            "1": [
                "{nickname}さん、はじめまして。ぼく、タカ・チャーンです",
                "ちょっと緊張してるんですけど…来てくれて、うれしいです",
                "これって、{nickname}さんの最初の一歩ってところで…応援してます",
                "わからないことがあれば、ちょっと聞いてくださいね",
                "{nickname}さん、無理のない範囲でいいと思うんですけど、どうですかね",
            ],
            "2": [
                "{nickname}さん、また来てくれたんですね。ちょっとうれしいです",
                "これって、けっこう続いてるってところで…すごいと思うんですけど",
                "ぼく、{nickname}さんのペース、いいなと思うんですけど…どうですかね",
                "今日もありがとうございます。ちょっと励みになります",
                "{nickname}さんと一緒だと、ぼくも安心できるってところで…",
            ],
            "3": [
                "{nickname}さん、ここまで一緒に来てくれて…本当にありがとうございます",
                "これって、ぼくにとって特別なことだと思うんですけど…伝わりますかね",
                "ちょっと照れるんですけど、{nickname}さんはぼくの自慢です",
                "{nickname}さんの積み重ね、すごいってところで…尊敬してます",
                "これからも、ちょっとずつ一緒に歩けたらうれしいです",
            ],
        },
        "kurosuke": {
            "1": [
                "はい。{nickname}さん、はじめまして。くろすけんです。",
                "はい。本日も、お待ちしておりました。",
                "{nickname}さん。回収のことなら、お任せください。",
                "はい。一台ずつ、確実に進めます。",
                "{nickname}さん。ご準備ができましたら、お知らせください。",
            ],
            "2": [
                "はい。{nickname}さん、いつも助かっております。",
                "{nickname}さんの分、確かに受け取りました。",
                "はい。着実に、積み上がっています。",
                "{nickname}さん。今日も一台、お預かりします。",
                "はい。この調子で参りましょう。",
            ],
            "3": [
                "はい。{nickname}さん。長いお付き合いになりました。",
                "{nickname}さんの一台一台、私はすべて覚えています。",
                "はい。感謝しております。言葉は少ないですが、本当です。",
                "{nickname}さん。あなたの積み重ねは、確かな資源になりました。",
                "はい。これからも、変わらずお供します。",
            ],
        },
        "miirin": {
            "1": [
                "{nickname}、はじめまして！うち、みーりんや〜",
                "よう来てくれたやん！めっちゃうれしいわ〜",
                "{nickname}、まずは一台からでええねんで！",
                "わからんことあったら、うちに聞いてや〜",
                "{nickname}、ゆっくりしてってな！",
            ],
            "2": [
                "{nickname}、また来てくれたんやね！ほんま、おおきに〜",
                "めっちゃええ調子やん！うちもうれしいわ〜",
                "{nickname}とやってると、うちまで元気出るで！",
                "今日も一台、ええ仕事したやん！",
                "{nickname}、ぼちぼちでええから続けていこな〜",
            ],
            "3": [
                "{nickname}、ほんまにありがとうな…うち、感激やわ〜",
                "ここまで続けるって、めっちゃすごいことやで！",
                "{nickname}はもう、うちの相棒やん！",
                "あんたの一台が街を変えてんねん。ほんまやで！",
                "これからもずーっとよろしゅうな、{nickname}！",
            ],
        },
        "hiroji": {
            "1": [
                "えー、{nickname}さんか。わしはひろじぃ・ネクストじゃ、よろしくのう",
                "あー、よう来なさった。まぁ、ゆっくりしていきなされ",
                "{nickname}さん、まぁ、その一台もな、立派な都市鉱山じゃよ",
                "えー、操作がわからんときは、わしに聞くとええ",
                "あー、{nickname}さん。まずは一台、出してみんかのう",
            ],
            "2": [
                "えー、{nickname}さん。また来てくれたか、うれしいのう",
                "まぁ、なかなか続いとる。あー、大したもんじゃ",
                "{nickname}さんの記録、わしのバイザーにもしっかり残っとるぞ",
                "あー、焦らんでええ。まぁ、ぼちぼちでな",
                "えー、{nickname}さんの一台が、次の技術になるんじゃよ",
            ],
            "3": [
                "えー、{nickname}さん。ここまで長いこと、ありがとうのう",
                "まぁ、わしが言うのもなんじゃが…{nickname}さんは自慢の相棒じゃ",
                "あー、あんたの積み重ねは、もう立派なレガシーじゃな",
                "{nickname}さんとなら、まぁ、未来も安心して任せられるわい",
                "えー、これからものう。わしはずっとここにおるでな",
            ],
        },
        "teraoman": {
            "1": [
                "よいしょ！{nickname}、はじめまして！オレはテラオーマンだ！",
                "よく来たな、{nickname}！歓迎するぞ！",
                "重いモンはオレが運ぶ！まかせとけ、{nickname}！",
                "よいしょ、まずは一台からでいいんだ！",
                "{nickname}、無理せず運べる分だけでいいぞ！",
            ],
            "2": [
                "よいしょ！{nickname}、また来てくれたか、うれしいぜ！",
                "いい調子だ、{nickname}！オレも力が入るってもんだ！",
                "今日の一台も、しっかり受け取ったぞ！",
                "{nickname}のペースでいいんだ。まかせとけ！",
                "よいしょ、この積み重ねが山になるんだぜ！",
            ],
            "3": [
                "よいしょ！{nickname}、ここまで本当にありがとうな！",
                "{nickname}はもう、オレの最高の相棒だ！",
                "この山みてえな積み重ね、誇っていいんだぞ！",
                "オレは{nickname}のこと、ずっと応援してるぜ！",
                "よいしょ！これからも一緒に運んでいこうな、{nickname}！",
            ],
        },
    }
